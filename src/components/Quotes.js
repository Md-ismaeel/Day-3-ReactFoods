        ...
        {Data.map((items, index) => {
          return (
            <div className="container" key={index}>
              <h1 style={{ textAlign: "center" }}>{items.desc}</h1>
              <p style={{ fontSize: "16px", opacity: "0.8" }}>{items.author}</p>
            </div>
          );
        })}
      </div>
